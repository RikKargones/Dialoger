...
---
- Возможность добавить анимированные текстуры к персоне, настроить условия их сробатывания.
- Редактируемая форма предпросмотра или возможность подгрузить свою собственную, сделанную в Godot по определенным правилам.
